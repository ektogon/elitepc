<?php
/* Smarty version 4.5.2, created on 2024-05-07 10:23:04
  from 'D:\OSPanel\domains\pc.loc\views\default\product.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.2',
  'unifunc' => 'content_6639d6d8a1f913_72384899',
...
function content_6639d6d8a1f913_72384899 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="container">
    <div class="flex url">
        <a href="/">Каталог</a>
        <a>></a>
...
" <?php if ($_smarty_tpl->tpl_vars['itemInCart']->value) {?>class="hideme"<?php }?> href="#" onClick="addToCart(<?php echo $_smarty_tpl->tpl_vars['rsProducts']->value['id'];?>
...
" <?php if (!$_smarty_tpl->tpl_vars['itemInCart']->value) {?>class="hideme"<?php }?> href="#" onClick="removeFromCart(<?php echo $_smarty_tpl->tpl_vars['rsProducts']->value['id'];?>
); window.location.reload(); return false;">
                    <button class="flex add_to_cart" data-id="<?php echo $_smarty_tpl->tpl_vars['rsProducts']->value['id'];?>
">
                        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
