            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="counter_btn"  id="BtnPlus_{$item['id']}" onmouseover="counter({$item['id']})">+</button>
                            <input name="itemCnt_{$item['id']}" id="itemCnt_{$item['id']}" class="counter_value_{$item['id']}" value ="1"
                                onchange="conversionPrice({$item['id']});" >
                            <button class="counter_btn" id="BtnMinus_{$item['id']}" onmouseover="counter({$item['id']})" >-</button>
                        </td>
                        <td>
                            ...
                            <a id="removeCart_{$item['id']}" href="#"
                                ...
                                <svg width="32" enable-background="new 0 0 32 32" id="Editable-line" version="1.1"
                                    ...
                                    <path fill="#BD1C1C"
                                        ...
                                        id="XMLID_129_" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-miterlimit="10" stroke-width="2" />
                                    <path fill="#BD1C1C" d="  M20,7h-8V5c0-1.105,0.895-2,2-2h4c1.105,0,2,0.895,2,2V7z"
                                        fill="none" id="XMLID_145_" stroke="#000000" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
                                    <path fill="#BD1C1C" d="  M28,10H4V8c0-0.552,0.448-1,1-1h22c0.552,0,1,0.448,1,1V10z"
                                        fill="none" id="XMLID_146_" stroke="#000000" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" />
